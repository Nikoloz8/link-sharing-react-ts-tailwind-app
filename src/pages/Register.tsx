...
export default function Register() {
    ...
    return (
        <div className="flex flex-col gap-[50px] items-center">
            ...
            <form action="" className="bg-[#FFFFFF] flex flex-col gap-[40px] p-[40px] rounded-[12px]" onSubmit={(e) => e.preventDefault}>
                <div>
                ...
                <div className="flex flex-col gap-[24px]">
                    <div className="flex flex-col gap-[4px]">
                        ...
                        <input type="text" id="email" className={`${inputStyle} bg-[url('/images/icon-email.svg')]`} {...register("emailAddress")} placeholder="e.g. alex@email.com" />
                    </div>
                    <div className="flex flex-col gap-[4px]">
                        <label htmlFor="createPassword" className={`${P2}`}>Create password</label>
                        <input type="text" id="createPassword" className={`${inputStyle} bg-[url('/images/icon-password.svg')]`} {...register("createPassword")} placeholder="At least 8 characters" />
                    </div>
                    <div className="flex flex-col gap-[4px]">
