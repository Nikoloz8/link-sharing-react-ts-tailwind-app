...
export default function Preview({ allMenuList, platformLinks, image, watch }: TMainOutletContext) {
    ...
    return (
        <div className="flex flex-col items-center h-[100%]">
            <div className="w-[100%] rounded-[0_0_32px_32px] h-[40vh] bg-[#633CFF] p-[24px]">
            ...
            <div className="p-[48px_56px] flex flex-col gap-[56px] rounded-[24px] bg-[#FFFFFF] shadow-[0_0_32px_0_rgba(0,0,0,0.1)] mt-[-150px]">
