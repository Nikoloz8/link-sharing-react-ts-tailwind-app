  ...
  return (
    <div className="w-[100%] min-h-[100vh] p-[24px] flex flex-col gap-[24px]">
      ...
      <main className="flex gap-[24px] h-[834px]">
        <section className="w-[560px] min-w-[450px] h-[100%] rounded-[12px] bg-[#FFFFFF] bg-[url('/images/illustration-phone-mockup.svg')] bg-no-repeat bg-center">
        </section>
        <section className="w-[100%] h-[100%] p-[40px_0_40px_0] flex bg-[#FFFFFF] rounded-[12px] flex-col gap-[40px]">
          ...
          <div className="flex flex-col gap-[24px] p-[0_40px]!">
            <button className={`w-[100%] p-[11px_0] text-center cursor-pointer ${H2} text-[#633CFF]! border-[1px] border-solid border-[#633CFF]! rounded-[8px]`}>+ Add new link</button>
            <div className="w-[100%] p-[62.5px_20px] rounded-[12px] bg-[#FAFAFA] flex flex-col items-center gap-[40px]">
