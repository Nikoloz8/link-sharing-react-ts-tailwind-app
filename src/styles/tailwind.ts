export default function tailwind() {
    ...
    const inputStyle = `w-[400px] bg-[#FFFFFF] p-[12px_16px_12px_44px] bg-no-repeat bg-[16px_center] outline-none rounded-[8px] border-[1px] boder-solid border-[#D9D9D9] focus:border-[#633CFF] focus:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] ${P1}`
