...
export default function LoginForm() {
    ...
    const { onSubmitLogin } = index({ watch, setError })

    return (
        <form action="" className="bg-[#FFFFFF] flex flex-col gap-[40px] p-[40px] rounded-[12px]" onSubmit={handleSubmit(onSubmitLogin)}>
            <div>
