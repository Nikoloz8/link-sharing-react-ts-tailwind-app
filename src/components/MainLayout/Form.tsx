...
export default function Form() {
    ...
    return (
        <div className="flex p-[20px] justify-between max-xl:mb-[50px]! items-center rounded-[12px] bg-[#FAFAFA] ">
            <form className="w-[100%] flex flex-col gap-[12px]" action="">
                <div className="flex items-center justify-between max-xl:flex-col max-xl:items-start w-[100%]!">
                ...
                <div className="flex items-center max-xl:flex-col max-xl:items-start justify-between w-[100%]! ">
