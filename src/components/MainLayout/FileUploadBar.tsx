...
export default function FileUploadBar() {
    ...
    return (
        <div className="flex p-[20px] max-xl:flex-col max-xl:gap-[24px] max-xl:items-center! justify-between items-center rounded-[12px] bg-[#FAFAFA] ">
            <h5 className={`${P1} text-[#737373] inline max-xl:w-[100%] max-xl:text-left`}>Profile picture</h5>
            <div className="flex gap-[24px] max-xl:flex-col items-center max-xl:justify-start">
