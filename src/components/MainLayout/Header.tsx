...
export default function Header({ isTablet }: { isTablet: boolean }) {
    ...
    return (
        <header className="flex w-[100%] bg-[#FFFFFF] p-[16px] items-center justify-between rounded-[12px]">
            ...
            }} className={`p-[11px_27px] max-sm:p-[11px_16px] rounded-[8px] border-[1px] border-solid border-[#633CFF] ${H2} text-[#633CFF]! hover:bg-[#EFEBFF] cursor-pointer`}>
